...
export default function RouteError({
  ...
  return (
    <div className="min-h-[calc(100vh-120px)] bg-gray-50 flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        <div className="text-7xl mb-6">😕</div>
        <h1 className="text-2xl font-bold text-secondary mb-2">Что-то пошло не так</h1>
        <p className="text-gray-500 mb-6">
          Не удалось загрузить данные. Пожалуйста, попробуйте ещё раз.
        </p>
        {error.digest && (
          <p className="text-xs text-gray-400 mb-4 font-mono">Код: {error.digest}</p>
        )}
